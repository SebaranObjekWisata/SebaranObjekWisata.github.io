...
map.getView().fit([12145267.655078, 10313.201147, 12332458.948092, 104969.171397], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Tempat Wisata di Kabupaten Landak</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (70 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini menunjukan lokasi persebaran Objek Wisata di Kabupaten Landak';
            }
